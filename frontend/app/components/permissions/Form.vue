...
<template>
  <UForm :schema="schema" :state="state" @submit="onSubmit" class="space-y-8">
    ...
    <div class="space-y-6 w-full">
      ...
      <!-- Display Name -->
      <UFormField label="Display Name" name="display_name" required class="w-full">
        <UInput 
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <UFormField label="Resource" name="resource" required class="w-full">
          <USelectMenu
        ...
        <UFormField label="Action" name="action" required class="w-full">
          <USelectMenu
      ...
      <div v-if="generatedName">
        ...
        <div class="mt-1 px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded-md">
    ...
    <div class="space-y-6 w-full">
      ...
      <div v-if="!contextStore.isSystemContext && mode === 'create'">
        ...
        <p class="mt-1 text-sm">This permission will be created for: <strong>{{ contextStore.selectedOrganization?.name }}</strong></p>
      </div>
    </div>
    ...
    <div v-if="mode === 'edit' && props.permission && !props.permission.is_system" class="space-y-6 w-full">
      ...
      <div class="rounded-lg border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20 p-6">
        ...
        <div class="space-y-4">
          <div>
            <h4 class="font-medium">Delete this permission</h4>
