  ...
  <div class="space-y-6">
    ...
    <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <UCard class="hover:shadow-md transition-shadow cursor-pointer" @click="navigateTo('/settings/users')">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-muted-foreground">Manage system-wide user accounts</p>
            </div>
          </div>
        </UCard>

        <UCard class="hover:shadow-md transition-shadow cursor-pointer" @click="navigateTo('/settings/settings')">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-muted-foreground">Configure system options</p>
            </div>
          </div>
        </UCard>

        <UCard class="hover:shadow-md transition-shadow cursor-pointer" @click="navigateTo('/settings/entity-types')">
          <div class="flex items-center gap-3">
