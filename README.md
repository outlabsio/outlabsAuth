...
[project]
dependencies = ["outlabs-auth>=0.1.0a3,<0.2"]
...
[tool.uv.sources]
outlabs-auth = { git = "ssh://git@github.com/<org>/outlabsAuth.git", tag = "v0.1.0a3" }
```
...
**Current Library Version**: 0.1.0a3
**Current Admin UI Version**: 0.1.0-alpha.3
**Release Stage**: Alpha
