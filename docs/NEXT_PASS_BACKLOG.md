...
- ✅ **User handbook polish (docs-library)** — handbook home + reading paths; Introduction / Choosing a Preset; rewritten User Management API against live routers; humanized invitations, status, API keys, JWT openings; audience headers across topic guides. Content source for a future Nuxt docs site.
