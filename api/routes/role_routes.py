...
async def create_role(
    ...
    role = await RoleService.create_role(
        ...
        entity_type_permissions=role_data.entity_type_permissions,
    ...
    return RoleResponse(
        ...
        entity_type_permissions=role.entity_type_permissions or {},
        entity_id=entity_id,
...
async def update_role(
    ...
    role = await RoleService.update_role(
        ...
        entity_type_permissions=update_data.entity_type_permissions,
