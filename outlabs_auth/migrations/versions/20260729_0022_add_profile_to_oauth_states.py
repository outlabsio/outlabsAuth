"""Add frontend profile binding to OAuth states (DD-059 slice 3).

Revision ID: 20260729_0022
Revises: 20260729_0021
Create Date: 2026-07-29 15:00:00.000000+00:00
"""
...
down_revision: Union[str, None] = "20260729_0021"
...
def upgrade() -> None:
    ...
    if not _column_exists(schema, "oauth_states", "profile_id"):
        op.add_column(
            "oauth_states",
...
def downgrade() -> None:
    schema = _current_schema()
    if _column_exists(schema, "oauth_states", "profile_id"):
        op.drop_column("oauth_states", "profile_id", schema=schema)
