...
/**
 * API Key status enum
 * Matches APIKeyStatus in outlabs_auth/models/sql/enums.py
 */
...
/**
 * API Key response
 * Matches ApiKeyResponse in outlabs_auth/schemas/api_key.py
 */
 ...
 * Matches ApiKeyCreateRequest in outlabs_auth/schemas/api_key.py
 */
 ...
 * Matches ApiKeyCreateResponse in outlabs_auth/schemas/api_key.py
 ...
 * Matches ApiKeyUpdateRequest in outlabs_auth/schemas/api_key.py
